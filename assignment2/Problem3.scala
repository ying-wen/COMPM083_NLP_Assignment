...
object Problem3Triggers {
  ...
  def main(args: Array[String]) {
    ...
    val triggerModel = SimpleClassifier(triggerLabels, Features.p3TriggerFeatures)
    // val triggerModel = SimpleClassifier(triggerLabels, Features.NBTriggerFeatures)
...
object Problem3Arguments {
  def main (args: Array[String] ) {
    ...
    // define model
    val argumentModel = SimpleClassifier(argumentLabels, Features.p3ArgumentFeatures)
    // val argumentModel = SimpleClassifier(argumentLabels, Features.NBArgumentFeatures)
