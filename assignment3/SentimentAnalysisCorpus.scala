...
//  var subtrain: Corpus = loadCorpus(io.Source.fromFile("./data/assignment3/subtrain.tsv", "ISO-8859-1").getLines())

  var trainCounter = 0
  var devCounter = 0
  var debugCounter = 0
  var testCounter = 0
//  var subtrainCounter = 0
...
//    case "subtrain" => subtrain.size
  ...
  def getExample(corpus: String): Example = corpus match {
    ...
    case "test" =>
      ...
      test(testCounter)
//    case "subtrain" =>
//      if (subtrainCounter == subtrain.length - 1) {
//        subtrain = random.shuffle(subtrain)
//        subtrainCounter = -1
//      }
//      subtrainCounter = subtrainCounter + 1
//      train(subtrainCounter)
  }
}